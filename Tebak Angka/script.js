...
window.addEventListener('load', function () {
  if (typeof (Storage) !== 'undefined') {
    ...
    if (sessionStorage.getItem(sessionAnswerKey) === null) sessionStorage.setItem(sessionAnswerKey, '');
    if (sessionStorage.getItem(sessionUserAttemptsKey) === null) sessionStorage.setItem(sessionUserAttemptsKey, 0);
    if (sessionStorage.getItem(sessionUserIsPlayingKey) === null) sessionStorage.setItem(sessionUserIsPlayingKey, false);
  ...
  } else alert('Browser yang Anda gunakan tidak mendukung Web Storage');
